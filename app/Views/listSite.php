...
<head>
    ...
    <link href="<?= base_url('css/zabuto_calendar.css') ?>" rel="stylesheet">
    <link href="<?= base_url('css/lib/bootstrap-fileupload/bootstrap-fileupload.css') ?>" rel="stylesheet">
    <link href="<?= base_url('lib/gritter/css/jquery.gritter.css') ?>" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="<?= base_url('css/style.css') ?>" rel="stylesheet">
    <link href="<?= base_url('css/style-responsive.css') ?>" rel="stylesheet">
    <link rel="stylesheet" href="<?= base_url('css/addHR.css') ?>">
...
<body>
    <section id="container">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li>
                                <a style="color:green;" href="<?php echo base_url('SiteController/listSite'); ?>">LIST
                                    OF SITE
                                    </a>
                            </li>
                        </ul>
        ...
        <section id="main-content">
            <section class="wrapper site-min-height">
                <h3><i class="fa fa-angle-right"></i> LIST OF SITES</h3>
                <div class="content">
                    <div>
                        ...
                        <div class="table-wrapper">
                            <table class="table table-striped table-bordered table-hover" id="siteTable">
                                ...
                                <tbody id="siteTableBody" style="background-color:white">
                                    <?php foreach ($sites as $num => $site): ?>
                                        <tr>
                                            <td><?= $num + 1 ?></td>
                                            <td><?= esc($site['siteID']) ?></td>
                                            <td><?= esc($site['siteName']) ?></td>
                                            <td><?= esc($site['siteAddress']) ?></td>
                                            <td><?= esc($site['startDate']) ?></td>
                                            <td><?= esc($site['endDate']) ?></td>
                                            <td><?= esc($site['location']) ?></td>
                                            <td style="text-align: center;">
                                                <?php if ($site['status'] == 'Active'): ?>
                                                    <p class="label label-success"><?= esc($site['status']) ?></p>
                                                <?php elseif ($site['status'] == 'Not Active'): ?>
                                                    <p class="label label-danger"><?= esc($site['status']) ?></p>
                                                <?php else: ?>
                                                    <p class="label label-default"><?= esc($site['status']) ?></p>
                                                <?php endif; ?>
                                            </td>
                                            <td>
                                                <a href="<?= base_url("editSite/" . $site['siteID']) ?>"
                                                    class="btn btn-primary btn-sm">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <a href="<?= base_url("deleteSite/" . $site['siteID']) ?>"
        ...
        <footer class="site-footer">
            <div class="text-center">
                <p>&copy; Specially Made For Bintara Camar Security SDN BHD</p>
                <div class="credits">Created with Love by Iruman</div>
            </div>
        </footer>
    </section>
    ...
    <script src="<?= base_url('lib/gritter/js/jquery.gritter.js') ?>"></script>
    <script src="<?= base_url('lib/gritter-conf.js') ?>"></script>
    ...
    <script src="<?= base_url('lib/bootstrap-fileupload/bootstrap-fileupload.js') ?>"></script>
