        ...
        <section id="main-content">
            <section class="wrapper site-min-height">
                <div class="container">
                    <div class="form">
                        ...
                        <button class="btn btn-theme" type="button" onclick="showContent('content4')">PREVIOUS
                            EMPLOYMENT</button>
                        <button class="btn btn-theme" type="button" onclick="showContent('content5')">EX-POLICE OR ARMY
                            DETAILS</button>
                            ...
                            <div class="container">
                                <div class="form"><br>
                                    <fieldset>
                                        ...
                                        <form action="insertGuardPersonalDetails" method="POST"
                        ...
                        <div id="content2" class="content-block">
                            <div class="container">
                                <div class="form">
                                    <form action="<?= base_url('adminController/createGuardFamilyDetails') ?>"
                                        method="POST">
                                        <fieldset>
                        ...
                        <div id="content3" class="content-block">
                            <div class="container">
                                <div class="form">
                                    <form action="<?= base_url('adminController/updateGuardEdu') ?>" method="POST">
                                        <fieldset>
                        ...
                        <div id="content4" class="content-block">
                            <div class="container">
                                <div class="form">
                                    <form action="<?= base_url('adminController/updateGuardPrevEmployment') ?>"
                                        method="POST">
                                        <fieldset>
                        ...
                        <div id="content5" class="content-block">
                            <div class="container">
                                <div class="form">
                                    <form action="<?= site_url('yourcontroller/insertGuardPrevExPoliceOrArmy') ?>"
                                        method="POST">
                                        <fieldset>
                        ...
                        <div id="content6" class="content-block">
                            <div class="container">
                                <div class="form">
                                    <form
                                        action="<?= isset($guardReference) ? site_url('yourcontroller/updateGuardReference') : site_url('yourcontroller/insertGuardReference') ?>"
                                        method="POST">
                                        <fieldset>
                                            <legend>
                                                Personal References
                                            </legend>
                                            <!-- Include guardID only if updating -->
                                            <?php if (isset($guardReference)): ?>
                                                <input type="hidden" name="guardID"
                                                    value="<?= $guardReference['guardID'] ?>">
                                            <?php endif; ?>
                                            ...
                                            <table>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <input type="text"
                                                            value="<?= isset($guardReference) ? $guardReference['guardReferName'] : '' ?>"
                                                            placeholder="Enter reference name" class="form-control"
                                                            name="guardReferName" required />
                                                    </td>

                                                    <td>
                                                        <label>REFERENCE JOB:</label>
                                                        <input type="text"
                                                            value="<?= isset($guardReference) ? $guardReference['guardReferJob'] : '' ?>"
                                                            placeholder="Enter reference job" class="form-control"
                                                            name="guardReferJob" required />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                        ...
                                                        <textarea class="form-control" name="guardReferAddress"
                                                            ...
                                                            required><?= isset($guardReference) ? $guardReference['guardReferAddress'] : '' ?></textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <input type="text"
                                                            value="<?= isset($guardReference) ? $guardReference['guardReferRelation'] : '' ?>"
                                                            placeholder="Enter relationship" class="form-control"
                                                            name="guardReferRelation" required />
                                                    </td>
                                                    <td>
                                                        <label>REFERENCE TELEPHONE NO:</label>
                                                        <input type="text"
                                                            value="<?= isset($guardReference) ? $guardReference['guardReferPhoneNo'] : '' ?>"
                                                            placeholder="Enter phone number" class="form-control"
                                                            name="guardReferPhoneNo" required />
                                                    </td>
                                                </tr>
                                            </table>
                                        </fieldset>
                                        <button type="submit"
                                            class="btn btn-success"><?= isset($guardReference) ? 'UPDATE' : 'SUBMIT' ?></button>
                                    </form>
                                </div>
                            </div>
                        </div>
                ...
                <script>
                    ...
                    function goToNextForm(currentForm, nextFormId) {
                        // Submit the form data
                        currentForm.submit();

                        // Hide current form and show next form
                        setTimeout(function () {
                            showContent(nextFormId);
                        }, 500); // Give it a slight delay for the form to submit
                    }

                    // This function will handle the submit and go to next form
                    function handleFormSubmit(event, currentForm, nextFormId) {
                        event.preventDefault(); // Prevent the default form submission
                        goToNextForm(currentForm, nextFormId);
                    }
                </script>
